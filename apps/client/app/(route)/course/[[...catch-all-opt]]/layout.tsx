  ...
  return (
    <>
      ...
      <div className="flex pt-[50px]">
        <div
          className={`hidden 800px:block w-[25%] 1100px:w-[20%] border-r bg-white dark:bg-slate-900 dark:border-gray-600`}
        >
        ...
        {openSideBar && (
          <div className={`800px:hidden border-r dark:border-gray-600`}>
            <div className="fixed w-[75%] 400px:w-[60%] top-[100px] bottom-0 overflow-y-auto bg-white dark:bg-slate-900">
              <SideLayout />
            </div>
          </div>
        )}
