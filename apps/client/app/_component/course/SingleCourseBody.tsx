...
const SingleCourseBody = () => {
  return (
    <div className="800px:flex">
      <div className="p-4 text-center 800px:fixed 800px:w-[30%] 800px:bg-white 800px:dark:bg-slate-900 800px:border-r dark:border-gray-600 left-0 top-[103px] bottom-0 overflow-y-auto">
